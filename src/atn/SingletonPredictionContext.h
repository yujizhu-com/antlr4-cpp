...
namespace atn {
  ...
  public:
    ...
    static CppRef<const SingletonPredictionContext> create(CppRef<const PredictionContext> parent, size_t returnState);
    ...
    const CppRef<const PredictionContext> parent;
    const size_t returnState;

    SingletonPredictionContext(CppRef<const PredictionContext> parent, size_t returnState);
