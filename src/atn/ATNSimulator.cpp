...
const CppRef<DFAState> ATNSimulator::ERROR = std::make_shared<DFAState>(std::numeric_limits<int>::max());
...
CppRef<const PredictionContext> ATNSimulator::getCachedContext(const CppRef<const PredictionContext> &context) {
